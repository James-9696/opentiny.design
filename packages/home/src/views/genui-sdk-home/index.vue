...
import genuiAbility1 from '@/assets/genui/genui_ability_1.svg'
import genuiAbility2 from '@/assets/genui/genui_ability_2.png'
import genuiAbility3 from '@/assets/genui/genui_ability_3.svg'
import genuiActionVedioCover from '@/assets/genui/genui_action_vedio_cover.webp'
import genuiFlowVedioCover from '@/assets/genui/genui_flow_vedio_cover.svg'
import genuiInteraction from '@/assets/genui/genui_interaction.gif'
import genuiFlow from '@/assets/genui/genui_flow.gif'
...
const actionCover = ref(genuiActionVedioCover)
const flowVedioCover = ref(genuiFlowVedioCover)

const handleActionCoverClick = () => {
  actionCover.value = genuiInteraction
}

const handleFlowVedioCoverClick = () => {
  flowVedioCover.value = genuiFlow
}
</script>
...
<template>
  <div class="genui-sdk-container">
    ...
    <!-- 第三屏 -->
    <home-ability class="home-ability-2" title="更加流畅的交互方式" subtitle="打破两步交互，实现界面到对话的一站式流转">
      <img class="cover-image ability-image" :src="actionCover" alt="genui-action-vedio-cover" @click="handleActionCoverClick" />
    </home-ability>
    ...
    <home-ability
      ...
      :content="heroBgWhite"
    >
      <img class="cover-image ability-image" :src="flowVedioCover" alt="genui-flow-vedio-cover" @click="handleFlowVedioCoverClick" />
    </home-ability>
...
.genui-sdk-container {
  ...
  .home-core {
    ...
    background-image: url('@/assets/genui/genui_ability_bg_1.svg');
