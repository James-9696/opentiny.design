...
const handleAction = ({ llmFriendlyMessage, humanFriendlyMessage }: { llmFriendlyMessage: string; humanFriendlyMessage: string }) => {
  // 处理按钮点击事件
...
<template>
  <section class="home-extend">
    ...
    <div class="home-extend-schema-renderer" ref="schemaRendererRef">
      <SchemaRenderer
        v-if="message" 
