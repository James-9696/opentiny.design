...
export const bannerList = {
  pc: [
    ...
    },
    {
      ...
      bg: $pub('images/home/slogan/bg5.webp'),
  ...
  mobile: [
    {
      title: 'MCP生态变革',
      description: '详解逆向思维的技术创新',
      icon: $pub('images/home/slogan/logo-blue.svg'),
      iconTitle: 'OpenTiny NEXT',
      bg: $pub('images/home/slogan/mobile_bg2.webp'),
      link: 'https://mp.weixin.qq.com/s/xMx5sfKGh2R-oZPGUwv70A'
    },
    {
      title: '亮相 GOSIM HANGZHOU2025',
      ...
      icon: $pub('images/home/slogan/logo-green.svg'),
      iconTitle: 'OpenTiny NEXT',
      bg: $pub('images/home/slogan/mobile_bg3.webp'),
      link: 'https://mp.weixin.qq.com/s/BhwpmnBtPke42zxNTsb9fQ'
    },
    {
      title: '推出Space组件',
      description: '搞定「弹性+间距」布局',
      icon: $pub('images/tiny-vue.svg'),
      iconTitle: 'TinyVue',
      bg: $pub('images/home/slogan/mobile_bg4.webp'),
      link: 'https://mp.weixin.qq.com/s/_QB7mTzSpHEt7ExK2MFUFw'
    },
    {
      title: '物料自动导入工具上手指南',
      description: '支持多种导入方式',
      icon: $pub('images/tiny-engine.svg'),
      iconTitle: 'TinyEngine',
      bg: $pub('images/home/slogan/mobile_bg5.webp'),
      link: 'https://mp.weixin.qq.com/s/Slq1vJbA3G7ZiKLxsF4nMQ'
    }
  ]
}
...
export const firstBanner = {
  pc: {
    title: '企业智能前端开发解决方案',
    descriptionA1: '以生成式 UI + WebMCP 两大自主核心技术为基础，加速企业应用的智能化改造',
    descriptionA2: '传统应用引入 OpenTiny NEXT 进行智能化改造后，可通过自然语言让智能体代替人自主完成任务',
    icon: $pub('images/home/slogan/logo-blue.svg'),
    iconTitle: 'OpenTiny NEXT',
    bg: $pub('images/home/slogan/bg1.webp'),
    link: 'https://mp.weixin.qq.com/s/xMx5sfKGh2R-oZPGUwv70A'
  },
  mobile: {
    title: '前端开发解决方案',
    descriptionA1: '两大自主核心技术',
    descriptionA2: '加速企业应用的智能化改造',
    icon: $pub('images/home/slogan/logo-blue.svg'),
    iconTitle: 'OpenTiny NEXT',
    bg: $pub('images/home/slogan/mobile_bg1.webp'),
    link: 'https://mp.weixin.qq.com/s/xMx5sfKGh2R-oZPGUwv70A'
  }
}
