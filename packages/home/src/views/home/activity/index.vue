  ...
  <div class="updates-guide">
    <div class="updates-inner">
      ...
      <div class="tab-content">
        <!-- 热点推荐：左侧精选大卡片 + 右侧四个精选小卡片（带角标） -->
        <template v-if="activeTab === 0">
          <!-- 左侧大卡片：左上角角标 -->
          <div class="content-large pick-card" @click="handleCardClick(currentContent.large.link)">
            <img 
        ...
        <template v-else>
          <!-- 左侧大卡片 -->
          <div class="content-large pick-card" :class="{ 'has-text': activeTab !== 1 }" @click="handleCardClick(currentContent.large.link)">
            <!-- 视频课程：只显示背景图 -->
...
const tabs = [
  { icon: getImgStatusUrl('hot-icon'), label: '热点推荐' },
...
const allContents = [
  ...
  // 1: 视频课程
  {
    link: 'https://space.bilibili.com/15284299/lists/7785424?type=season',
    large: {
      bgImage: getImgStatusWebpUrl('video-1'),
      title: '',
      desc: '',
