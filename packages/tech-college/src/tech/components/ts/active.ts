    ...
    data: [
      {
        ...
        link: '/tech-college/article/hot/goism?name=热门活动&type=hot',
        instruct: {
          write: '原创',
          declaration: '作者：',
          author: '胡艳鑫',
      ...
      },
      {
        ...
        link: '/tech-college/article/hot/5?name=热门活动&type=hot',
        instruct: {
          write: '原创',
          declaration: '作者：',
          author: '胡艳鑫',
      ...
      },
      {
        ...
        link: '/tech-college/article/hot/6?name=热门活动&type=hot',
        instruct: {
          write: '原创',
          declaration: '作者：',
          author: '胡艳鑫',
    ...
    data: [
      {
        ...
        img: teacher,
        link: '/tech-college/article/news/1?name=最新活动&type=news'
      },
      {
        markId: '2', //与markdown文件同名
      ...
      },
      {
        ...
        link: '/tech-college/article/news/4?name=最新活动&type=news',
        instruct: {
          write: '原创',
          declaration: '作者：',
          author: '胡艳鑫',
      ...
      },
      {
        ...
        link: '/tech-college/article/news/5?name=最新活动&type=news',
        instruct: {
          write: '原创',
          declaration: '作者：',
          author: '胡艳鑫',
      ...
      },
      {
        ...
        link: '/tech-college/article/news/6?name=最新活动&type=news',
        instruct: {
          write: '原创',
          declaration: '作者：',
          author: '胡艳鑫',
