...
export function descriptionData() {
  ...
  const hotsData = [
    ...
    },
    {
      ...
      link: '/tech-college/article/feature/tinycharts/1?name=%E7%89%B9%E6%80%A7%E4%BB%8B%E7%BB%8D&subName=Tinycharts',
      instruct: {
        write: '原创',
        declaration: '作者：',
        author: '张涵宇',
    ...
    },
    {
      markId: '5', //与markdown文件同名
      title: 'Node.js调试能力分析',
      link: '/tech-college/article/technology/node/9?name=%E5%89%8D%E7%AB%AF%E6%8A%80%E6%9C%AF&subName=Node',
      instruct: {
        write: '原创',
        declaration: '作者：',
        author: '屈金雄',
